...
<div align="center">
  ...
  <h3><b>Order Summary Component</b></h3>
...
**[ Order Summary Component ]** This challenge is to build out an order summary card component and get it looking as close to the design as possible.
...
- https://cuauh-cabrera.github.io/order-summary/
...
```sh
  cd my-folder
  git@github.com:cuauh-cabrera/order-summary.git
```
